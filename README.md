...
# Issues
I did run into issues when attempting to get the names of the titles, y-axis and x-axis to appear. I was able to correct this by restarting my kernal and rerunning all the data.
I also ran into issues getting the charts for the Northern and Southern Hemisphere to reflect correctly but was able to go through and find the error that was causing this.

# Resources 
Speaking with/working with classmates, referring to the websites: w3schools and Stack Overflow for further guidance.
